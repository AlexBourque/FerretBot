# FerretBot
A discord bot that makes use of Google's API for Image/Youtube searches, has a system for responding to certain phrases, and keeps track of an abitrary points systems for members of a guild.

Based of the boilerplate code [guidebot](https://github.com/An-Idiots-Guide/guidebot)
